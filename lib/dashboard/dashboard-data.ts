...
export const DASHBOARD_WIDGETS: DashboardWidget[] = [
  { id: "critical-alerts", title: "Critical alerts", kind: "alerts", roles: ["dispatcher", "supervisor", "director", "administrator"], permission: "dashboard:view", pinned: true, lazy: false, density: "command", refreshSeconds: 5 },
  { id: "mechanic-today", title: "Сегодняшние заявки", kind: "stream", roles: ["mechanic"], permission: "work_orders:read", pinned: true, lazy: false, density: "compact", refreshSeconds: 20 },
  { id: "ops-stream", title: "Operational stream", kind: "stream", roles: ["dispatcher", "warehouse", "supervisor", "director", "administrator"], permission: "dashboard:view", pinned: true, lazy: false, density: "command", refreshSeconds: 3 },
  { id: "ops-map", title: "Operations map", kind: "map", roles: ["dispatcher", "supervisor", "director"], permission: "objects:read", pinned: true, lazy: true, density: "comfortable", refreshSeconds: 10 },
  { id: "kpi-engine", title: "KPI engine", kind: "kpi", roles: ["dispatcher", "warehouse", "supervisor", "director", "administrator"], permission: "analytics:read", pinned: true, lazy: false, density: "comfortable", refreshSeconds: 30 },
  { id: "ai-insights", title: "AI insights", kind: "ai", roles: ["dispatcher", "supervisor", "director", "administrator"], permission: "analytics:read", pinned: false, lazy: true, density: "comfortable", refreshSeconds: 60 },
  { id: "offline-sync", title: "Offline sync", kind: "offline", roles: ["mechanic", "warehouse", "dispatcher"], permission: "dashboard:view", pinned: true, lazy: false, density: "compact", refreshSeconds: 15 },
];

const everyone: UserRole[] = ["mechanic", "dispatcher", "warehouse", "supervisor", "director", "administrator"];

export const KPI_METRICS: KpiMetric[] = [
  { id: "sla", label: "SLA %", value: "93.4", unit: "%", delta: "+1.8%", trend: "up", severity: "info", roles: ["supervisor", "director"] },
  { id: "daily-emergencies", label: "Аварии за день", value: "11", delta: "+3", trend: "up", severity: "warning", roles: ["dispatcher", "supervisor", "director"] },
  { id: "mttr", label: "Среднее время ремонта", value: "1ч 42м", delta: "-12м", trend: "down", severity: "info", roles: ["supervisor", "director"] },
  { id: "open-wo", label: "Open work orders", value: "184", delta: "+19", trend: "up", severity: "warning", roles: ["dispatcher", "supervisor", "director", "administrator"] },
  { id: "overdue", label: "Overdue jobs", value: "27", delta: "+5", trend: "up", severity: "critical", roles: ["dispatcher", "supervisor", "director"] },
  { id: "profitability", label: "Profitability", value: "18.2", unit: "%", delta: "future-ready", trend: "flat", severity: "info", roles: ["director"] },
  { id: "active-mechanics", label: "Active mechanics", value: "37", delta: "4 on-call", trend: "flat", severity: "info", roles: ["dispatcher", "supervisor", "director"] },
  { id: "active-calls", label: "Active calls", value: "42", delta: "+8", trend: "up", severity: "warning", roles: ["dispatcher"] },
  { id: "emergency-queue", label: "Emergency queue", value: "5", delta: "2 critical", trend: "up", severity: "critical", roles: ["dispatcher"] },
  { id: "delayed-mechanics", label: "Delayed mechanics", value: "6", delta: "traffic", trend: "up", severity: "warning", roles: ["dispatcher"] },
...
export const DASHBOARD_ALERTS: DashboardAlert[] = [
  ...
  { id: "alert-2", type: "sla_violation", title: "SLA violation risk", description: "6 заказ-нарядов приблизились к порогу реагирования", severity: "critical", slaMinutesRemaining: 18, roles: ["dispatcher", "supervisor", "director"], escalationLevel: 2 },
  ...
  { id: "alert-5", type: "ai_anomaly", title: "AI anomaly", description: "Повторяющиеся отказы дверей SC-88420 выше базовой линии на 240%", severity: "warning", roles: ["dispatcher", "supervisor", "director"], escalationLevel: 2 },
...
export const AI_INSIGHTS: AiInsight[] = [
  { id: "ai-1", title: "Risk object", description: "БЦ Север: повторные отказы дверного узла, высокий SLA риск", confidence: 91, category: "risk_objects", roles: ["dispatcher", "supervisor", "director"] },
