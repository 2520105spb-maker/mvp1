...
export const DEMO_USERS: AuthUser[] = [
  ...
  },
  {
    ...
    position: "Старший механик бригады Север-1",
    phone: "+7 900 021-66-40",
    role: "seniorMechanic",
    department: "Сервис Север",
    status: "active",
    permissions: ROLE_PERMISSIONS.seniorMechanic,
  ...
  },
  {
    id: "u-emerg-006",
    name: "Сергей Волков",
    position: "Координатор аварийных выездов",
    phone: "+7 900 006-03-03",
    role: "emergencyCoordinator",
    department: "Аварийная диспетчеризация",
    status: "active",
    permissions: ROLE_PERMISSIONS.emergencyCoordinator,
    scope: { organizationId: "neo", regionIds: ["central", "south", "north"], territoryIds: ["t-center-1", "t-yug-2", "t-north-1"], objectIds: [], warehouseIds: ["wh-central", "wh-south", "wh-north"] },
  },
  {
    id: "u-wh-002",
    name: "Олег Романов",
...
export function buildSession(role: UserRole, rememberSession: boolean): AuthSession {
  ...
  return {
    ...
    rememberSession,
    biometricReady: role === "mechanic" || role === "seniorMechanic",
